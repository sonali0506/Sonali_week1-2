...
// 		country.selectByIndex(1); 
 ...
 WebElement checkboxagreement ;
 	...
 	private WebElement contd_click;
 		...
 		@FindBy(xpath="//div[@id='System_nyHsmShk']/div/p")
 	...
 	//	@FindBy(xpath="//A[@href='http://retail.hommelle.com/account/account'][text()='Continue']")
 	//	private WebElement contd_click2;
 		
 		
 		
 	//		public void sendclickContinueBtn2() {
 			
 		//	this.contd_click2.click(); 
