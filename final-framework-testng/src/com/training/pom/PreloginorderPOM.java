...
public class PreloginorderPOM {
	...
	//click view cart
		...
		private WebElement contd_click;
			...
			public void sendclickContinueBtn22() {
...
//						country.selectByIndex(1); 
				...
				//  Select State from dropdown	
					...
					private WebElement passwordship; 
					
					
					public void sendpwdship(String pw1) {
						this.passwordship.clear();
						this.passwordship.sendKeys(pw1);
					}	
					
					@FindBy(id="input-payment-confirm")
					private WebElement conpassword1; 
					
					
					public void sendconpwd1(String pw2) {
						this.conpassword1.clear();
						this.conpassword1.sendKeys(pw2);
					}	
					
					
					//*[@id="collapse-payment-address"]/div/div[2]/div[1]/label/input
					@FindBy(xpath="//*[@id=\"collapse-payment-address\"]/div/div[2]/div[1]/label/input")
					
					WebElement checkboxagreementship ;
						 
						
						
						public void sendcheckboxship() {
								this.checkboxagreementship.click();
						}	
						...
						private WebElement contdguest_click;
							...
							public void sendclickContinueshiptBtn() {
							...
							private WebElement contdguest_click30;
							
							
								public void sendclickContinueshiptBtn30() {
								
								this.contdguest_click30.click(); 
